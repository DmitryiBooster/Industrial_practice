...
public class TeacherUpdateDTO {
    ...
    // 'работает', 'в отпуске', 'на больничном'--
    @Size(min = 7, max = 30)
    ...
    public TeacherUpdateDTO(String firstName, String lastName, int age, String email, String phone, String educational, String status) {
